...
def wishMe():
    ...
    if hour>=6 and hour<12:
        speak("Good Morning! asit")

    elif hour>=12 and hour<18:
        speak("Good Afternoon! asit")

    elif hour>=18 and hour<24:
        speak("Good Evening! asit")

    else:
        speak("Good Night! asit")

    speak("mewww at your service! Please tell me how can I help you?")
#wishMe()
def takeCommand():
...
if __name__ == "__main__":
    ...
    while True:
        ...
        #open youtube
        elif 'meww open youtube' in query:
         webbrowser.open("youtube.com")

        #open google
        elif 'meww open github' in query:
            webbrowser.open("github.com")

        #open stackoverflow
        elif 'meww open stackoverflow' in query:
            webbrowser.open("stackoverflow.com")

       #time
        elif 'mewww what is the time now' in query:
            strTime = datetime.datetime.now().strftime("%H:%M:%S")
            speak(f"Sir, the time is {strTime}")

        elif 'open code' in query:
            codePath = "C:\\Users\\asitm\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
            os.startfile(codePath)  
